...
if uploaded_modelo and uploaded_planilhas:
    formato = st.radio("Formato dos arquivos a gerar:", ["DOCX", "PDF", "Ambos"])
        ...
        if st.button("Gerar documentos"):
            ...
            with zipfile.ZipFile(zip_buffer, "w") as zf:
                for loc, itens in agrupado.items():
                    ...
                    filename_base = f"{loc.replace(' ', '_')}_{'_'.join(meses_selecionados)}"
